...
cp /tmp/iml/_topdir/RPMS/rust-iml-{action-runner,agent-comms,api,cli,mailbox,ntp,ostpool,postoffice,sfa,stats,device,warp-drive,size-test}-*.rpm /tmp/manager-rpms/
